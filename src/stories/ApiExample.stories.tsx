...
import ApiPaginationSortingExample from '../examples/ApiPaginationSortingExample';
import '@sanbira/atom-grid-table/style.css';

const meta = {
  title: 'Examples/API Examples',
  component: ApiPaginationSortingExample,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'Example of AtomGridTable with server-side pagination and sorting'
      }
    }
  },
} satisfies Meta<typeof ApiPaginationSortingExample>;

export default meta;
type Story = StoryObj<typeof meta>;

export const ApiPaginationSorting: Story = {
  render: () => <ApiPaginationSortingExample />,
